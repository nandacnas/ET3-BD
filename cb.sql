...
CREATE TABLE CHEFE_MILITAR(
    ...
    FOREIGN KEY(NOME_LIDER, COD_GRUPO) REFERENCES LIDER_POLITICO (NOME_LIDER, COD_GRUPO) ON UPDATE CASCADE,
    FOREIGN KEY(NRO_DIVISAO, COD_GRUPO) REFERENCES DIVISAO (NUM_DIVISAO, COD_GRUPO) ON UPDATE CASCADE
