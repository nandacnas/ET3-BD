...
CREATE TABLE CONFLITO(
    NOME CHAR(50),
    COD_CONFLITO SERIAL NOT NULL CONSTRAINT COD_CONF_UNIQ UNIQUE,
    TIPO CHAR(12) CHECK (TIPO IN ('territorial', 'religioso', 'racial', 'economico')),
    NUM_FERIDOS INT,
    NUM_MORTOS INT ,
...
CREATE TABLE CHEFE_MILITAR(
    ...
    FOREIGN KEY(NOME_LIDER, LP_COD_GRUPO) REFERENCES LIDER_POLITICO (NOME_LIDER, COD_GRUPO) ON UPDATE CASCADE ON DELETE CASCADE,
    FOREIGN KEY(NUM_DIVISAO, D_COD_GRUPO) REFERENCES DIVISAO (NUM_DIVISAO, COD_GRUPO) ON UPDATE CASCADE ON DELETE CASCADE
...
CREATE TABLE ORGANIZACAO_M(
    COD_ORGANIZACAO SERIAL NOT NULL,
    NOME_ORG CHAR(50),
    TIPO_ORG CHAR(50),
    TIPO_AJUDA CHAR(50),
    NUM_PESSOAS INT,
...
CREATE TABLE CONFLITO_TERRITORIAL(
    ...
    TIPO CHAR(12) CHECK (TIPO = 'territorial') DEFAULT 'territorial',
...
CREATE TABLE CONFLITO_RELIGIOSO(
    ...
    TIPO CHAR(12) CHECK (TIPO = 'religioso') DEFAULT 'religioso',
...
CREATE TABLE CONFLITO_ECONOMICO(
    ...
    TIPO CHAR(12) CHECK (TIPO = 'economico') DEFAULT 'economico',
...
CREATE TABLE CONFLITO_RACIAL(
    ...
    TIPO CHAR(12) CHECK (TIPO = 'racial') DEFAULT 'racial',
